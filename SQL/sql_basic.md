...
### 계층형 질의
: 테이블에 계층형 데이터가 존재하는 경우 데이터를 조회하기 위해 사용.<br>
<br>
...
- **COONECT_BY_ISCYCLE** : 해당 데이터가 조상이면 1, 아니면 0 (CYCLE 옵션 사용했을 시만 사용 가능)<br>
<br>
...
4. SELECT, FROM, WHERE, HAVING, ORDER BY, INSERT-VALUES, UPDATE-SET 절에 사용 가능하다.<br>
<br>
**단일 행 비교 연산자** : =, <, >, <> 등
...
3. **보안성** : 직원의 급여정보와 같이 숨기고 싶은 정보가 존재할 때 사용할 수 있다.<br>
